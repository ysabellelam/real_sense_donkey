...
#import donkeycar.parts.Realsense_Camera_Part as RS
...
# Case for realsense
            ...
            from donkeycar.parts.RealsenseCameraPart import RealsenseCameraPart
            cam = RealsenseCameraPart(image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH)
        else:
