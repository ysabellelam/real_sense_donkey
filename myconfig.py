...
# 
# #CAMERA
CAMERA_TYPE = "REALSENSE"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|MOCK)
IMAGE_W = 640
IMAGE_H = 480
IMAGE_DEPTH = 4 #Depth of 4 for RGBD from realsense         # default RGB=3, make 1 for mono
...
JOYSTICK_DEADZONE = 0.08             # when non zero, this is the smallest throttle before recording triggered.
